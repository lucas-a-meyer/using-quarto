...
I created one main content file [(source)](https://github.com/lucas-a-meyer/using-quarto/blob/main/_presentation-content.qmd) that imports each [slide](https://github.com/lucas-a-meyer/using-quarto/tree/main/slides), to create:
